...
import { ChevronRight, ChevronDown, HelpCircle, Sparkles, Coins, Lock, Bot, Zap, Users } from 'lucide-react';
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-xl border-b border-card-border">
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/faq" className="text-accent font-medium">FAQ</Link>
